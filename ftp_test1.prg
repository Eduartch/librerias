 ...
 * Note: In this Demo, all output is to the Foxpro main window
   ...
   * Note: ("21" is the Default Port)
	IF sz_ftp.OpenInternet("productos@softservicepluss.com", "clave", "ftp.softservicepluss.com", "21") 
...
*!*		    ListDir()
	   ...
	   *       TESTFILE.TXT file.
		...
		local cad, ruta
		ruta='D:\Accesorios\BaseDatos\'
		cad='Cases_Ecotrend_Nerubian_2605B.jpg'
		wait window ruta+cad
		IF !sz_ftp.PutFtpFile(upper(cad),ruta+cad)
			?sz_ftp.GetErrorCode(.T.)
		ENDIF
*!*		ListDir()
